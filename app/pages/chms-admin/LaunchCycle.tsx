                    ...
                    return (
                      <div key={cycle.id} className="py-4 first:pt-0 last:pb-0 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3 shrink-0">
                          {/* Status Badge */}
                          <span
                            className={`px-3 py-1 rounded-full text-xs font-bold inline-flex items-center gap-1 ${isOpen
                              ? isDeadlineReached
                          ...
                          <button
                            ...
                            className={`px-4 py-1.5 rounded-lg font-semibold text-xs transition-all shadow-sm flex items-center gap-1 ${isOpen
